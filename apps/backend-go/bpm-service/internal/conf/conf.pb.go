...
type Data struct {
	...
	Zeebe         *Data_Zeebe            `protobuf:"bytes,4,opt,name=zeebe,proto3" json:"zeebe,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data) GetZeebe() *Data_Zeebe {
	if x != nil {
		return x.Zeebe
	}
	return nil
...
func (x *Data_Zeebe) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Zeebe) ProtoMessage() {}

func (x *Data_Zeebe) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Zeebe.ProtoReflect.Descriptor instead.
func (*Data_Zeebe) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 3}
}

func (x *Data_Zeebe) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x05zeebe\x18\x04 \x01(\v2\x16.kratos.api.Data.ZeebeR\x05zeebe\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\bgroup_id\x18\x02 \x01(\tR\agroupId\x1a\x1b\n" +
	"\x05Zeebe\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\"^\n" +
	"\x03JWT\x12#\n" +
	"\rjwks_endpoint\x18\x01 \x01(\tR\fjwksEndpoint\x12\x16\n" +
	"\x06issuer\x18\x02 \x01(\tR\x06issuer\x12\x1a\n" +
	"\baudience\x18\x03 \x01(\tR\baudienceBNZLgithub.com/arda-labs/arda/arda-be-go/services/bpm-service/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Data_Zeebe)(nil),          // 9: kratos.api.Data.Zeebe
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 8: kratos.api.Data.zeebe:type_name -> kratos.api.Data.Zeebe
