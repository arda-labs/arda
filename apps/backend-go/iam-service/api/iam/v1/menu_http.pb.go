...
const OperationMenuServiceCreateMenu = "/iam.v1.MenuService/CreateMenu"
const OperationMenuServiceDeleteMenu = "/iam.v1.MenuService/DeleteMenu"
const OperationMenuServiceGetMenu = "/iam.v1.MenuService/GetMenu"
const OperationMenuServiceListMenus = "/iam.v1.MenuService/ListMenus"
const OperationMenuServiceUpdateMenu = "/iam.v1.MenuService/UpdateMenu"
...
func RegisterMenuServiceHTTPServer(s *http.Server, srv MenuServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/v1/me/menu", _MenuService_GetMenu0_HTTP_Handler(srv))
	r.GET("/v1/menus", _MenuService_ListMenus0_HTTP_Handler(srv))
