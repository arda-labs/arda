...
func wireApp(confServer *conf.Server, confData *conf.Data, jwt *conf.JWT, zitadel *conf.Zitadel, logger log.Logger) (*kratos.App, func(), error) {
	...
	tenantUserUsecase := biz.NewTenantUserUsecase(tenantUserRepo, roleRepo, permissionCache)
	...
	iamService := service.NewIAMService(userUsecase, tenantUsecase, tenantUserUsecase, roleUsecase, permissionUsecase, authUsecase, auditUsecase, groupUsecase, logger)
