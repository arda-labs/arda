...
import (
	...
	mdmv1 "github.com/arda-labs/arda/arda-be-go/services/mdm-service/api/mdm/v1"
...
func NewHTTPServer(c *conf.Server, jwt *conf.JWT, mdm *service.MdmService, logger log.Logger) *khttp.Server {
	...
	mdmv1.RegisterMdmServiceHTTPServer(srv, mdm)
