...
type Bootstrap struct {
	...
	Zitadel       *Zitadel               `protobuf:"bytes,4,opt,name=zitadel,proto3" json:"zitadel,omitempty"`
...
func (x *Bootstrap) GetZitadel() *Zitadel {
	if x != nil {
		return x.Zitadel
	}
	return nil
...
type JWT struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	JwksEndpoint  string                 `protobuf:"bytes,1,opt,name=jwks_endpoint,json=jwksEndpoint,proto3" json:"jwks_endpoint,omitempty"`
...
func (x *JWT) GetJwksEndpoint() string {
	if x != nil {
...
func (x *Zitadel) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Zitadel) ProtoMessage() {}

func (x *Zitadel) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Zitadel.ProtoReflect.Descriptor instead.
func (*Zitadel) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{4}
}

func (x *Zitadel) GetAuthority() string {
	if x != nil {
		return x.Authority
	}
	return ""
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\azitadel\x18\x04 \x01(\v2\x13.kratos.api.ZitadelR\azitadel\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xed\x02\n" +
	"\x04Data\x125\n" +
	...
	"\x02db\x18\x05 \x01(\x05R\x02db\"^\n" +
	"\x03JWT\x12#\n" +
	"\rjwks_endpoint\x18\x01 \x01(\tR\fjwksEndpoint\x12\x16\n" +
	"\x06issuer\x18\x02 \x01(\tR\x06issuer\x12\x1a\n" +
	"\baudience\x18\x03 \x01(\tR\baudience\"9\n" +
	"\aZitadel\x12\x1c\n" +
	"\tauthority\x18\x01 \x01(\tR\tauthority\x12\x10\n" +
	"\x03pat\x18\x02 \x01(\tR\x03patB Z\x1eiam-service/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Zitadel)(nil),             // 4: kratos.api.Zitadel
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 3: kratos.api.Bootstrap.zitadel:type_name -> kratos.api.Zitadel
