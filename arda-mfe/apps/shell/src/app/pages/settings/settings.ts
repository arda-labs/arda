...
import { ThemeService } from '@arda-mfe/shared-core';
import { RADIUS, SCALE, FONTS, BASE_FONT_SIZE, ACCENT_COLORS, LINE_HEIGHTS, LETTER_SPACINGS } from '@arda-mfe/shared-theme';
...
function toOptions(obj: Record<string, unknown>): { label: string; value: string }[] {
